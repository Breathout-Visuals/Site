...
// Triggered automatically by Vite content watcher on changes in portfolio-freelance-content/

const fs = require('fs');
const path = require('path');

const CONTENT_DIR = path.resolve(__dirname, '../../portfolio-freelance-content');
const OUTPUT_FILE = path.resolve(__dirname, '../../src/portfolio-freelance/data/projects.gen.js');
