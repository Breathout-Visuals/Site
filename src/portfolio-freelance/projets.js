...
const T = {
  fr: { all:'Tout', empty:'Ajoutez des projets dans portfolio-freelance-content/', phTitle:'Projets', countSuffix:'réalisations publiques' },
  en: { all:'All',  empty:'Add projects to portfolio-freelance-content/', phTitle:'Projects', countSuffix:'public works' },
};
