...
const T = {
  fr: {
    ...
    empty: 'Ajoutez un dossier dans portfolio-freelance-content/ et relancez le script.',
  },
  en: {
    ...
    empty: 'Add a folder to portfolio-freelance-content/ and run the script.',
  },
};
...
function buildCard(proj) {
  ...
  card.addEventListener('click', () => {
    window.location.href = `/portfolio-freelance/project.html?p=${proj.slug}`;
  });
